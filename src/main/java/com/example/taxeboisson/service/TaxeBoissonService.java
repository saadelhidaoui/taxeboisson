...
public class TaxeBoissonService {
    ...
    @Transactional
    public int deleteByRedevableTypeRedevableCode(String code) {
        return taxeBoissonDao.deleteByRedevableTypeRedevableCode(code);
    }
    @Transactional
    ...
    @Transactional
    public int deleteByLocaleCategorieLocaleRef(String ref) {
        return taxeBoissonDao.deleteByLocaleCategorieLocaleRef(ref);
    }
